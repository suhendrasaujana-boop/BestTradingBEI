...
with col2:
    ...
    # Tombol copy rekomendasi (auto copy)
    copy_text = rekomendasi.replace("**", "").replace("\n", " | ")
    st.button(f"📋 Copy Rekomendasi", on_click=None, key="copy_btn")
    st.caption("Klik kanan → Copy teks di atas")
